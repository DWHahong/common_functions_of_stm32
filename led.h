...
#define  LED5(x)   GPIOE->ODR=(GPIOE->ODR&~GPIO_Pin_3) | (x ? GPIO_Pin_3 : 0) 
#define  LED6(x)   GPIOE->ODR=(GPIOE->ODR&~GPIO_Pin_4) | (x ? GPIO_Pin_4 : 0) 
#define  LED7(x)   GPIOE->ODR=(GPIOE->ODR&~GPIO_Pin_5) | (x ? GPIO_Pin_5 : 0) 
#define  LED8(x)   GPIOE->ODR=(GPIOE->ODR&~GPIO_Pin_6) | (x ? GPIO_Pin_6 : 0) 
#define  LED9(x)   GPIOB->ODR=(GPIOB->ODR&~GPIO_Pin_1) | (x ? GPIO_Pin_1 : 0) 
